...
class RunbookRepositoryServer:
    ...
    def __init__(self,
                 discovery_strategy: RunbookDiscoveryStrategyABC,
                 vector_strategy: DBVectorStrategyABC,
                 persistence_strategy: PersistenceStrategyABC,
                 notification_strategy: NotificationStrategyABC):
        """
